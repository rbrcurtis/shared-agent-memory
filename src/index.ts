...
function printIngestSummary(
  result: Awaited<ReturnType<typeof ingestClaudeCodeTranscript>>,
): void {
  console.log(
    ...
    tools: [
      {
        name: "store_memory",
        description:
          "Store a memory in the detected current git project by default. REQUIRED params: title, text. Pass project only when deliberately saving knowledge for a different related repo.",
        inputSchema: {
          type: "object",
          properties: {
            text: {
            ...
            title: {
              type: "string",
              description:
                "Short descriptive title for the memory (max 10 words)",
            },
            agent: {
              type: "string",
            ...
            project: {
              type: "string",
              description:
                "Optional project override. Omit to store in the detected current git project.",
            },
            tags: {
              type: "array",
              items: { type: "string" },
      ...
      },
      {
        name: "search_memory",
        description:
          "Search memories by semantic similarity. Searches all accessible projects by default and returns titles, IDs, projects, and scores — use load_memories to get full text for selected results.",
        inputSchema: {
          type: "object",
          properties: {
            query: {
            ...
            project: {
              type: "string",
              description:
                "Optional project filter. Omit to search all accessible projects.",
            },
            tags: {
              type: "array",
              items: { type: "string" },
      ...
      },
      {
        name: "load_memories",
        description:
          "Load full text of memories by IDs. Use after search_memory to retrieve details for selected results. Reinforces loaded memories.",
        inputSchema: {
          type: "object",
          properties: {
            ids: {
      ...
      },
      {
        name: "list_recent",
        description:
          "List recent memories across all accessible projects by default. Returns titles, IDs, and projects — use load_memories for full text.",
        inputSchema: {
          type: "object",
          properties: {
            limit: { type: "number", description: "Max results (default 10)" },
            ...
            project: {
              type: "string",
              description:
                "Optional project filter. Omit to list all accessible projects.",
            },
          },
        },
      },
      {
        name: "update_memory",
        description:
          "Update an existing memory with new text. Use this to keep memories current when information changes.",
        inputSchema: {
          type: "object",
          properties: {
      ...
      },
      {
        name: "get_config",
        description:
          "Get the current MCP server configuration including detected project name.",
        inputSchema: {
          type: "object",
          properties: {},
        },
